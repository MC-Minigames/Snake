...
public class register1_7_9 {
	public static boolean registerEntities() {
		...
		try {
			...
			c_map.put("MESheep", MEFallingBlock1_7_9.class);

			Field d = entityTypeClass.getDeclaredField("d");
			d.setAccessible(true);
			HashMap d_map = (HashMap) d.get(null);
			d_map.put(MEFallingBlock1_7_9.class, "MESheep");
	...
	public static MEFallingBlock1_7_9 spawnSheep(Main m, String arena, Location t, final int color) {
		final Object w = ((CraftWorld) t.getWorld()).getHandle();
		final MEFallingBlock1_7_9 t_ = new MEFallingBlock1_7_9(m, arena, t, (net.minecraft.server.v1_7_R3.World) ((CraftWorld) t.getWorld()).getHandle());
