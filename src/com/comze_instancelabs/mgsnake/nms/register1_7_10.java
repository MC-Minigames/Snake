...
public class register1_7_10 {
	...
	public static MESheep1_7_10 spawnSheep(Main m, String arena, Location t, final int color) {
		final Object w = ((CraftWorld) t.getWorld()).getHandle();
		final MESheep1_7_10 t_ = new MESheep1_7_10(m, arena, t, (net.minecraft.server.v1_7_R4.World) ((CraftWorld) t.getWorld()).getHandle());
